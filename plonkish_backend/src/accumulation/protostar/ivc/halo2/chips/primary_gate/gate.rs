...
//     poly::Rotation,
// }, utils::PrimeField};
// use halo2_base::halo2_proofs::halo2curves::{Coordinates, CurveAffine};
// use halo2_base::halo2_proofs::halo2curves::ff::PrimeFieldBits;
// use itertools::Itertools;

// use crate::accumulation::protostar::ivc::primary::{ecc::circuit::AssignedPoint, utils::{self, get_power_of_two_iter, normalize_trailing_zeros}};
...
// mod tests {
//     use super::*;
//     // use crate::poly::polynomial::{ColumnIndex, Expression};
