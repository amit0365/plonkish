...
#[derive(Clone, Debug)]
pub(super) struct CompressionConfig<F> {
    lookup: SpreadInputs,
...
impl<F:PrimeField> Table16Assignment<F> for CompressionConfig<F> {}
...
mod tests {
    ...
    use halo2_proofs::{
        circuit::{Layouter, SimpleFloorPlanner}, dev::MockProver, halo2curves::bn256::Fr, plonk::{Circuit, ConstraintSystem, Error}
    };
