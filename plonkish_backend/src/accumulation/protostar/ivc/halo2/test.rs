...
//     let trivial_circuit = TrivialCircuit::<bn256::G1Affine>::default();
//     let primary_circuit  = RecursiveCircuit::new(true, trivial_circuit, None, circuit_params.clone());
//     // let halo2_circuit =
...
pub mod strawman {
        ...
        C::Base: BigPrimeField,  
    {
        ...
        // todo can do unchecked here saves 600 advices
        ...
        C::Scalar: BigPrimeField + FromUniformBytes<64> + PrimeFieldBits,
    {
        ...
        pub fn squeeze_challenge(
            ...
            let (challenge_le_bits, challenge) = {
                ...
                // let hash = std::mem::replace(&mut self.poseidon_chip, poseidon_chip_new).squeeze(builder.main(), &range_chip.gate);
                let hash = self.poseidon_chip.squeeze(builder.main(), &range_chip.gate);
                // self.poseidon_chip.clear();
