...
use crate::accumulation::protostar::ivc::halo2::chips::poseidon::hash_chip::{PoseidonChip, Poseidon2Chip, Poseidon2Config};
    ...
    C::Scalar: BigPrimeField + FromUniformBytes<64> + PrimeFieldBits,
{
    pub fn configure(meta: &mut ConstraintSystem<C::Scalar>) -> Self {
        ...
        let poseidon_config = Poseidon2Pow5Chip::configure::<PoseidonChipSpec>(
            meta,
    ...
    C::Scalar: BigPrimeField + FromUniformBytes<64> + PrimeFieldBits,
{
    ...
    pub fn new(
        ...
        let cyclefold_hash_config = PoseidonSpec::<C::Base, T2, R2>::new(R_F, R_P);
        ...
        pub fn hash_cyclefold_inputs<Comm: AsRef<C>>(
            ...
            //let mut poseidon = Hash::<_, PoseidonSpec<C::Scalar, T, RATE>, ConstantLength<CF_HASH_LENGTH>, T, RATE>::init(); // PoseidonHash::from_spec(spec.clone());
        ...
        pub fn hash_state<Comm: AsRef<C>>(
            ...
            //let mut poseidon = Hash::<_, PoseidonSpec<C::Scalar, T, RATE>, ConstantLength<PRIMARY_HASH_LENGTH>, T, RATE>::new();
