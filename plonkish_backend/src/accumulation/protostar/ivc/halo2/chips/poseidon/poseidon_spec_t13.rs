...
//! Specification for rate 12 Poseidon using the BN256 curve.
//! Patterned after [halo2_gadgets::poseidon::primitives::P128Pow5T3]
use super::poseidon_params_t13 as poseidon_params;
...
impl Spec<Fp, 13, 12> for PoseidonSpec {
    ...
    fn constants() -> (Vec<[Fp; 13]>, Mds<Fp, 13>, Mds<Fp, 13>) {
        (
