...
pub(crate) fn cross_term_expressions<F: PrimeField>(
    ...
    println!("folding_degree: {:?}", folding_degree);
...
pub(crate) fn cross_term_expressions_par<F: PrimeField + Send + Sync>(
    ...
    let scalars_fold = products.par_iter()
        ...
        println!("Time for scalars_fold_time: {:?}", scalars_fold_time);
        ...
        println!("Time for scalars_reduce_time: {:?}", scalars_reduce_time);
        ...
        println!("Time for scalars_sum_time: {:?}", scalars_sum_time);
