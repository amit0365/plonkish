...
// };
// use halo2_base::{halo2_proofs::halo2curves::bn256::{Bn256, Fr}, gates::circuit::BaseCircuitParams};
// use rand::rngs::OsRng;

// #[test]
// fn vanilla_plonk_circuit_info() {
//     let circuit_params = BaseCircuitParams::default();
//     let circuit = Halo2Circuit::new::<HyperPlonk<()>>(3, VanillaPlonk::<Fr>::rand(3, OsRng), circuit_params);
...
//         let circuit_params = BaseCircuitParams::default();
//         let circuit = Halo2Circuit::new::<Pb>(num_vars, VanillaPlonk::rand(num_vars, OsRng), circuit_params);
